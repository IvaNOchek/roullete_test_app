...
public class RouletteWheel : MonoBehaviour
{
    ...
    {
        float totalWeight = prizes.Sum(p => p.probabilityWeight);
        ...
        {
            accumulatedWeight += prizes[i].probabilityWeight;
    ...
    private void UpdateWonPrizesText()
    {
        ...
        string AllprizesText = $"All items:\n{saveData.wonPrizes.Sum(p => p.amount)}\n";
        AllprizesText += $"All Weight:\n{totalWeight}";
